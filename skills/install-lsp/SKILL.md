---
name: install-lsp
description: Install and configure Language Server Protocol support for Claude Code. Use when the user wants to set up LSP for TypeScript, Python, or Java.
---
