...
| -------------- | -------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | --------- |
| `ml-pipelines` | `*.pt`, `*.pth` | `torch.nn`, `DataLoader`, `from transformers import`, `from sklearn import`, `lightning` | `model`, `training`, `evaluation`, `loss`, `optimizer`, `trainer`, `epoch`, `batch_size`, `learning_rate`, `validation`, `checkpoint` | `ml-pipeline-reviewer` | Available |
