...
For a complete, comprehensive example of this pattern in action, see:
`${CLAUDE_PLUGIN_ROOT}/skills/research-problem/SKILL.md` and `${CLAUDE_PLUGIN_ROOT}/skills/research-problem/references/agent-guide.md`

The research-problem skill is the **canonical implementation** with additional features:
- Batch-based agent spawning with context passing between batches
- Iterative research loops with re-verification after each iteration
- Detailed decision trees for when to skip agents (e.g., locator found sufficient detail)
- Maximum iteration limits with graceful degradation

Other commands implement a **simplified version** of this pattern, appropriate for their less complex workflows.
...
## Relationship to research-problem.md

- This shared file documents the **principles** of the pattern
- research-problem.md is the **reference implementation** with full inline details
- Other commands reference this shared file for principles
- When in doubt about implementation details, consult research-problem.md
