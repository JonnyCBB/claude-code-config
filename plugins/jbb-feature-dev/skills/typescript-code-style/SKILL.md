...
description: TypeScript/React code style patterns with before/after examples. Covers anti-patterns to avoid, modern TypeScript 5.0-5.8 features, React 18/19 patterns (use(), Actions, ref as prop), and project conventions. Use when reviewing TypeScript/React code quality or identifying refactoring opportunities.
allowed-tools:
  - Read
---
...
Concrete before/after code transformation examples for TypeScript and React code style.
