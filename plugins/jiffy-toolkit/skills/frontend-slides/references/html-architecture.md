  ...
  <head>
    ...
    <style>
      ...
      /* ===========================================
           ...
           One-liner dark/light values. Responds to OS preference.
           Requires color-scheme: light dark on :root.
           All browsers since May 2024. No fallback needed.
           =========================================== */
      /* Example pattern:
        :root {
            color-scheme: light dark;
            --bg-primary: light-dark(#ffffff, #0a0f1c);
            --text-primary: light-dark(#1a1a1a, #ffffff);
            --text-secondary: light-dark(#555, #9ca3af);
            --bg-surface: light-dark(#f5f5f5, #111827);
        }
        */
